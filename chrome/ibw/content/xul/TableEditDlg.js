...
// Changes:
//
// 16-12-2014  Eric Helsper:
// - Show full filenames in the listbox (provided by KH).
// - Saving without Description: no underscore in filename.
// - getValidTableDescription(): convert diacritics and other chars
//   in the Description which are not OK in file names.
// - If a table file is renamed by changing the tag and/or description,
//   the old file is removed.
// - If the new tag/description results in a file name that already
//   exists, the file is not saved; a message is popped up.
// - function convertTableName(): Commented out the call to this
//   function by request of KH; we agree it should not be default
//   behavior, but also fixed the function for the case when there is
//   no description in case it is re-enabled.
//===================================================
