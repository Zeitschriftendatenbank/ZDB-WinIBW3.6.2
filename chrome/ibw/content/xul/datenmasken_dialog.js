...
try {
	...
	if (!theFileInput.openSpecial("ProfD", "\\defaults\\datenmasken\\" + theList.value)) {
		if (!theFileInput.openSpecial("BinDir", "\\defaults\\datenmasken\\" + theList.value)) {
...
try {
	...
	theFileOutput.createSpecial("ProfD", "\\defaults\\datenmasken\\" + currentFilename);
